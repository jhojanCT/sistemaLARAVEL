                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="<?php echo e(route('ventas.materia_prima.index')); ?>">Venta de Mteria Prima</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('cuentas.index')); ?>">Cuentas</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo e(route('pagos.index')); ?>"> Credito de Ventas </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('credito_compras.index')); ?>"> Credito de Compras </a></li>
                        </ul>
                    </li>
